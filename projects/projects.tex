...
Additionally, a graphical user interface \gls{gui} is provided, leveraging \texttt{PyQt5}\cite{pyqt5} and \texttt{PyOpenGL}\cite{pyopengl} modules. The \glsentrytext{gui} manages the main window and handles OpenGL object management. It offers features like port selection and serial communication. The received data is displayed in a textbox within the \glsentrytext{gui}, facilitating real-time monitoring and analysis.
Here is how the \glsentrytext{gui} is threaded :
\begin{figure}[H]
    \centering
    \includegraphics[width=0.65\linewidth]{./projects/pmodnav/gui_threads.png}
    \caption{Python \glsentrytext{gui} threads schematic}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Python \glsentrytext{gui} window screenshot}
\end{figure}
...
\begin{table}[H]
    ...
    \begin{subfigure}[b]{0.475\textwidth}
        ...
        \caption{Ardupilot flight controller \gls{fc} configuration}
...
\begin{wrapfigure}[12]{l}{0.5\textwidth}
    \centering
    \includegraphics[width=0.4\textwidth]{./projects/ardupilot/ca_flowchart.png}
